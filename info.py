...
API_ID = int(environ.get('API_ID', '24320761'))
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002385959978').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002265651652') # give your force subscribe channel id here else leave it blank
